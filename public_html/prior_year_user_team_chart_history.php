...
$sql = "SELECT * FROM `user_picks_history` WHERE `userID` = $uid AND `raceYear` = '$prevRaceYear' AND `segment` = 'S1'";
...
$sql = "SELECT * FROM `user_picks_history` WHERE `userID` = $uid AND `raceYear` = '$prevRaceYear' AND `segment` = 'S2'";
...
$sql = "SELECT * FROM `user_picks_history` WHERE `userID` = $uid AND `raceYear` = '$prevRaceYear' AND `segment` = 'S3'";
...
$sql = "SELECT * FROM `user_picks_history` WHERE `userID` = $uid AND `raceYear` = '$prevRaceYear' AND `segment` = 'S4'";
