 ...
 *
 * VERSION: v002
 * GENERATED: 8/22/2026 7:36:00 pm America/New_York
 *
 ...
 *
 * INSTALLER CHANGELOG:
 *   v002 - Fixes an installer-only postflight false failure. The v001
 *          postflight incorrectly treated the still-valid activeSegment
 *          expression itself as evidence of the old POST-order bug.
 *          v002 instead verifies that RD POST fields occur BEFORE
 *          activeSegment derivation. Application-file transformations
 *          are otherwise unchanged from v001.
 *
 * PURPOSE:
...
$backupDir = $root . '/mrl_rd_real_flow_integration_backup_20260822_073600pm';
...
if (
    ...
    if (!empty($errors)) {
        ...
        $postflight = [
            ...
            ['Submit POST-order bug removed',
                strpos($after['submit'], '$rdSelectedSlotPost =') !== false
                && strpos($after['submit'], '$activeSegment =') !== false
                && strpos($after['submit'], '$activeSegment =') > strpos($after['submit'], '$rdSelectedSlotPost =')
            ],
...
<div class="banner">
    <h1>MRL Replacement Pick Real-Flow Integration Installer v002</h1>
    <div class="sub">TESTPHP8 ONLY • generated 8/22/2026 7:36:00 pm • database schema changes: NONE</div>
</div>
