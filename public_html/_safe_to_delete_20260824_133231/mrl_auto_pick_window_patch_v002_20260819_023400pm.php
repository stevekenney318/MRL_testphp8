 ...
 *
 * VERSION: v002
 * LAST MODIFIED: 8/19/2026 2:34:00 pm
 *
 * DESCRIPTION:
...
const INSTALLER_TIMESTAMP = '20260819_023400pm';
...
<div class="card"><h2>Preflight</h2><table><?php foreach($preflight as [$label,$status]): ?><tr><td><?php echo h((string)$label); ?></td><td class="<?php echo str_starts_with((string)$status,'PASS')?'pass':'fail'; ?>"><?php echo h((string)$status); ?></td></tr><?php endforeach; ?></table></div>
