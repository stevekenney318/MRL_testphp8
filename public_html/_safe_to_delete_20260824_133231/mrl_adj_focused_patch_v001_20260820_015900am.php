...
const PATCH_TS = '20260820_015900am';
...
<head>
<meta charset="utf-8">
<title>MRL Focused ADJ Patch v001</title>
<style>
...
<h1>MRL Focused ADJ Patch v001</h1>

<div class="card">
<b>Target:</b> <?php echo h($host); ?><br>
<b>Root:</b> <?php echo h($root); ?><br>
<b>Build:</b> 8/20/2026 1:59:00 am ET
</div>
...
<form method="post">
<button class="btn" name="action" value="install">INSTALL FOCUSED ADJ PATCH v001</button>
</form>
</div>
