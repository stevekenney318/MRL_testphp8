 ...
 * VERSION: v003
 * LAST MODIFIED: 8/24/2026 9:58:36 pm
 *
...
$backupDir = $root . '/mrl_open_pick_privacy_guard_backup_20260824_095836pm';
...
if ($preflightOk) {
    ...
    $preflightOk = pg_check(
        $checks,
        'count header insertion anchor',
        pg_c($countCurrent, "<?Php\nsession_start();\n") === 1,
        'Exact file-start anchor found once'
    ) && $preflightOk;
...
<head>
<meta charset="utf-8">
<title>MRL Open Pick Privacy Guard v003</title>
<style>
...
<body><div class="wrap">
<div class="head"><h1>MRL Open Pick Privacy Guard Installer v003</h1>
