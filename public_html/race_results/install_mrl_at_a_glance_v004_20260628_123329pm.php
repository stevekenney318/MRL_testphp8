<?php
/**
 * install_mrl_at_a_glance_v004.php
 *
 * VERSION: v004
...
echo "<p class=\"ok\">SUCCESS — mrl_at_a_glance.php v004 was installed.</p>";
...
echo "Change: Latest Snapshot uses standings_timeline-style labels\n";
